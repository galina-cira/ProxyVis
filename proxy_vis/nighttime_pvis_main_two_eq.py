...
def calculate_pvis_main_two_eq(
    ...
    """ProxyVis Main Two Regressions Equation
    ...
    Args:
        ...
        c11 (np.ndarray): IR band should be similar to GOES C11 band data.
        c13 (np.ndarray): IR band should be similar to GOES C13 band data.
        c15 (np.ndarray): IR band should be similar to GOES C15 band data.
